...
char managerUsername[25] = "efremhirko"; // global variable declaration and also initialization
char managerPassword[25] = "efrem123*"; // global variable declaration and also initialization
...
int main() { //starting with main function
  ...
  result = strcmp(get_pass, enter); //using string compare to compare get password from user if password is correct result is return to 0.
    ...
    system("cls"); // system clear screen is used to clear the screen for user to use in simple way
  }*/
